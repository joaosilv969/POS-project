(() => {
  ...
  if (memberName) {
    ...
    memberName.addEventListener("keydown", moveToFinishButton);
  }
  ...
  if (memberNumber) {
    ...
    memberNumber.addEventListener("keydown", moveToFinishButton);
  }
  ...
  document.addEventListener("keydown", (event) => {
    ...
    if (target === memberName || target === memberNumber) {
      return;
    }
