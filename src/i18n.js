...
const EN_TRANSLATIONS = {
  ...
  "A palavra-passe deve ter pelo menos 6 caracteres.": "The password must be at least 6 characters long.",
  ...
  "Email de pagamento recebido": "Payment receipt email",
  "Entre com utilizador e palavra-passe ou, em alternativa, apenas com PIN.": "Sign in with username and password or, alternatively, PIN only.",
  "Entre para gerir vendas, stock e produtos.": "Sign in to manage sales, stock, and products.",
  "Entrar": "Sign in",
  "Envio de estatutos, confirmações de pagamento, avisos de quotas em atraso e templates editáveis.":
    "Send statutes, payment confirmations, overdue dues notices, and editable templates.",
  ...
  "O CSV de sócios não tem linhas válidas.": "The members CSV has no valid rows.",
  "O ficheiro deve ser um CSV.": "The file must be a CSV.",
  ...
  "Pagamento": "Payment",
  "Pagamento de quota cancelado.": "Membership dues payment cancelled.",
  "Pagamento de quota registado, mas falta configurar o email de envio.": "Membership dues payment recorded, but sender email is not configured.",
  "Pagamento de quota registado, mas o email de confirmação falhou:": "Membership dues payment recorded, but the confirmation email failed:",
  "Pagamento de quota registado, mas o sócio não tem um email válido.": "Membership dues payment recorded, but the member does not have a valid email.",
  "Pagamento de quota registado.": "Membership dues payment recorded.",
  "Pagamento de quota registado. Email de confirmação enviado.": "Membership dues payment recorded. Confirmation email sent.",
  "Pagamento de quotas": "Dues payment",
  ...
  "Preencha nome, email e palavra-passe com pelo menos 6 caracteres.": "Enter name, email, and a password with at least 6 characters.",
  "Preencha os campos obrigatórios do produto.": "Fill in the required product fields.",
  "Preencha os campos obrigatórios do produto (inclui tamanho).": "Fill in the required product fields (including size).",
  ...
  "Produtos": "Products",
  "Produtos com stock baixo": "Products with low stock",
  ...
  "Relatório de quotas": "Dues report",
  ...
  "Selecione um ficheiro CSV para importar sócios.": "Select a CSV file to import members.",
  ...
  "Utilizadores": "Users",
  "Valor da quota atualizado para o ano indicado.": "Dues amount updated for the selected year.",
  "Valor padrão da quota atualizado.": "Default dues amount updated.",
  "Valor recebido": "Amount received",
  "Variáveis do email de pagamento recebido": "Payment receipt email variables",
